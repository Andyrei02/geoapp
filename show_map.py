...
class ShowMap:
    def __init__(self):
        self.jw_icon_path = os.path.join(os.getcwd(), "static", "img", "JW.png")
        self.jw_icon = folium.CustomIcon(self.jw_icon_path, icon_size=(30, 30))
    ...
    def make_map(self, lat, long_):
        ...
        folium.Marker(
            location=[47.769515, 27.511898],
            tooltip="Sala Regatului",
            popup="Sala Regatului a Martorilor lui Iehova, Strada Suveranității, Glodeni",
            icon=self.jw_icon,
        ).add_to(mymap)
